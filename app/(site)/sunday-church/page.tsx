...
function getFloorPlanSrc() {
  ...
  const floorPlanFile = readdirSync(imageDirectory).find((fileName) =>
    /^floor-plan\./i.test(fileName),
  );
...
export default async function SundayChurchPage() {
  ...
  return (
    <>
      <section
        aria-labelledby='sunday-church-heading'
      ...
      >
        <div className='mx-auto w-full max-w-container-max px-container-px py-section-v-mobile lg:px-container-px-lg lg:py-section-v'>
          <div className='max-w-3xl'>
            <p className='text-section-label tracking-[0.14em] text-on-surface-muted'>
              SUNDAY CHURCH
            </p>
            <h1
              id='sunday-church-heading'
              className='mt-stack-sm text-headline-mobile md:text-headline'
            >
              Gather With Us on Sundays
            </h1>
            <p className='mt-stack-md text-body-lg text-on-surface-muted'>
              Come worship with other young single adults in Tooele. Sacrament
              meeting begins at 11:00 AM, with second-hour classes following
              afterward.
            </p>
            <div className='mt-stack-lg grid gap-stack-md border-l-4 border-accent-rust pl-stack-md text-body-lg'>
              <p>
                <span className='block text-section-label tracking-[0.14em] text-on-surface-muted'>
                  Time
                </span>
      ...
      <section
        aria-labelledby='sacrament-program-heading'
        className='bg-surface-warm text-on-surface'
      >
        <div className='mx-auto w-full max-w-container-max px-container-px py-section-v-mobile lg:px-container-px-lg lg:py-section-v'>
          <div className='max-w-3xl'>
            <p className='text-section-label tracking-[0.14em] text-on-surface-muted'>
              ...
              <>
                ...
                program.organist ? (
                  <dl className='mt-stack-md grid gap-stack-sm border-l-4 border-accent-rust pl-stack-md text-body sm:grid-cols-2'>
                    {program.presiding ? (
                      <div>
                        <dt className='text-section-label tracking-[0.14em] text-on-surface-muted'>
                          Presiding
                        </dt>
                      ...
                      switch (item._type) {
                        case 'programHymn':
                          return (
                            <li
                              key={item._key}
                              className='grid gap-1 border-b border-border pb-stack-md'
                            >
        ...
        <div className='mx-auto w-full max-w-container-max px-container-px py-section-v-mobile lg:px-container-px-lg lg:py-section-v'>
          <div className='max-w-3xl'>
            ...
            <h2
              ...
              className='mt-stack-sm text-headline-mobile md:text-headline'
            >
              Find Your Way Around the Meetinghouse
            </h2>
          </div>
          <div className='mt-stack-lg grid gap-stack-lg lg:grid-cols-[minmax(0,1.25fr)_minmax(280px,0.75fr)] lg:items-start'>
            ...
            <div className='border-2 border-border bg-surface p-stack-md'>
              <h3 className='text-section-label tracking-[0.14em] text-on-surface-muted'>
        ...
        <div className='mx-auto w-full max-w-container-max px-container-px py-section-v-mobile lg:px-container-px-lg lg:py-section-v'>
          <div className='max-w-3xl'>
            ...
            <div className='mt-stack-md space-y-stack-md text-body-lg text-on-surface-muted'>
              <p>
                Parking is available around the chapel at 196 N Pinehurst Ave.
                Come in through the main entrance and look for a greeter or
                another YSA member if you want help finding the chapel or
                classrooms.
              </p>
              <p>
                A YSA sacrament meeting includes hymns, prayers, the sacrament,
                and short talks from ward members. Dress ranges from Sunday best
                to simple and comfortable. You can sit anywhere, participate as
                much as you feel comfortable, and stay afterward for second-hour
                classes and introductions.
              </p>
            </div>
          </div>
        </div>
