...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/tooele_ysa_ward/',
    iconSrc: '/images/app-icons/instagram.svg',
  },
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/groups/tooeleysa',
...
export default function LinksPage() {
  return (
    <>
        ...
        <div className='mx-auto w-full max-w-container-max px-container-px py-section-v-mobile lg:px-container-px-lg lg:py-section-v'>
          <div className='max-w-3xl'>
            ...
            <p className='mt-stack-md text-body-lg text-on-surface-muted'>
              Find the Church apps and ward social links members use most, all
              from one quick page.
            </p>
          </div>
        </div>
      ...
      <section
        aria-labelledby='link-tree-heading'
      ...
      >
        <div className='mx-auto w-full max-w-container-max px-container-px py-section-v-mobile lg:px-container-px-lg lg:py-section-v'>
          <div className='max-w-3xl'>
            ...
            <h2
              id='link-tree-heading'
              className='mt-stack-sm text-headline-mobile md:text-headline'
            >
              Open Your Go-To LDS Apps
            </h2>
            <p className='mt-stack-md text-body-lg text-on-surface-muted'>
              Jump straight to scripture study, young adult resources, member
              tools, and institute access.
            </p>
          </div>
